...
{
    [SerializeField]
    public SerializableScene _serializableScene;

    [SerializeField]
    bool _preloadOnStart;

    [SerializeField]
    LoadSceneMode _loadSceneMode;

    [SerializeField]
    bool _useSceneManager;
    ...
    [SerializeField]
    private AsyncOperation _asyncLoadOperation = null;
    ...
    public async Task<AsyncOperation> LoadSceneAsync(
        string sceneName,
        LoadSceneMode loadScenMode = LoadSceneMode.Single,
    ...
    )
    {
        ...
        // Decide whether to let the scene activate until it's loaded.
